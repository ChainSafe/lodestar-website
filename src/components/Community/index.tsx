...
import { sentenceVariant, letterVariant, splitText, slideUpVariant } from '../../styles/animations';
...
export const Community: React.FC = () => {
  ...
  const sentenceText = `Lodestar is an alternative client.`;
      ...
      <div className='community' ref={ref}>
        <div className='community--stats'>
          <div className='text-wrapper'>
              ...
              <p>Ethereum's decentralized network has greater resilience supporting multi-client architecture. Running minority clients reduces your risk during correlated failures.</p>
        ...
        >
          ...
          <motion.div className='card social' variants={slideUpVariant}>
            ...
            <div className='button-group'>
              <a href="https://discord.com/invite/yjyvFRP" target="__blank" rel="noopener noreferrer"><Button dark>Join Discord</Button></a>
